...
export const theme: EditorThemeClasses = {
  ...
  tableRowStriping: "",
  tableScrollableWrapper: "overflow-x-auto border border-editor-border rounded-md my-0 mb-6",
  tableSelected: "outline-2 outline-editor-primary",
  tableSelection: "bg-editor-primary/10 border-2 border-editor-primary/50 rounded",
  ...
  layoutItem: "border border-dashed border-border p-4 min-w-0 max-w-full rounded-md",
