  ...
  return (
    <DraggableBlockPlugin_EXPERIMENTAL
      ...
      menuComponent={
        <div
          ref={menuRef}
          className={`${DRAGGABLE_BLOCK_MENU_CLASSNAME} flex items-center size-7 rounded-md bg-background border border-border shadow-sm opacity-0 transition-opacity duration-200 cursor-grab active:cursor-grabbing hover:opacity-100 will-change-transform absolute left-0 top-0 z-50`}
        >
