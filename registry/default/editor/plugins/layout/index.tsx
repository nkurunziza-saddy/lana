...
import { $createLayoutItemNode, $isLayoutItemNode, LayoutItemNode } from "../../nodes/layout-item";
import { INSERT_LAYOUT_COMMAND, UPDATE_LAYOUT_COMMAND } from "./commands";
import { getItemsCountFromTemplate } from "./utils";

export { INSERT_LAYOUT_COMMAND, UPDATE_LAYOUT_COMMAND } from "./commands";
  ...
  useEffect(() => {
    ...
    return mergeRegister(
      ...
      editor.registerCommand(
        ...
        (template) => {
          editor.update(() => {
            const container = $createLayoutContainerNode(template as string);
            const itemsCount = getItemsCountFromTemplate(template as string);
      ...
      editor.registerCommand(
        ...
        (payload) => {
          const { template, nodeKey } = payload as {
            template: string;
            nodeKey: string;
          };
          editor.update(() => {
