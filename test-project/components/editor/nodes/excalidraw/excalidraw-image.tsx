...
export default function ExcalidrawImage({
  ...
  useEffect(() => {
    const setContent = async () => {
      const exportTheme = resolvedTheme === "dark" ? THEME.DARK : THEME.LIGHT;

      const backgroundColor = resolvedTheme === "dark" ? "transparent" : "transparent";
    ...
    void setContent();
  }, [elements, files, appState, resolvedTheme]);
